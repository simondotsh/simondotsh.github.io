...
* I did not manage to read [secret attributes](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-drsr/294168d9-81bf-461b-91d7-95bd8a985737) such as [unicodePwd](https://docs.microsoft.com/en-us/windows/win32/adschema/a-unicodepwd) using `DS-Replication-Get-Changes-All` through the `DirSync` LDAP control.
